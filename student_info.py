...
When an object of the class is created it will have to contain three arguments.
...
3:The third function 'def display_average_score' returns the average of the grades entered in the object of the class StudentInfo.
I then added the @property decorator on all the functions so the functions become properties of the class instead.
...
I have commented out this part and not deleted it so that anyone can quickly see that everything is working so far if they want to check.
